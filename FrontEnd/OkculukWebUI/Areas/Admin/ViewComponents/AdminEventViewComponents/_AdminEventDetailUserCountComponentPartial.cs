...
{
    public class _AdminEventDetailUserCountComponentPartial:ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public _AdminEventDetailUserCountComponentPartial(IHttpClientFactory httpClientFactory)
        {
